  ...
  return (
    <section className="rounded-2xl sm:rounded-3xl border border-cyan-400/20 bg-slate-900/60 p-2 backdrop-blur sm:p-3">
      ...
      <div className="mt-2 sm:mt-3 grid grid-cols-2 gap-1.5 sm:gap-2 text-xs">
        ...
        <div className="rounded-lg sm:rounded-xl bg-slate-950/70 py-2 px-2.5 sm:px-3">
          <p className="text-[10px] sm:text-xs text-slate-400">Time remaining</p>
        ...
        <div className="rounded-lg sm:rounded-xl bg-slate-950/70 py-2 px-2.5 sm:px-3">
          <p className="text-[10px] sm:text-xs text-slate-400">Questions asked</p>
        ...
        <div className="rounded-lg sm:rounded-xl bg-slate-950/70 py-2 px-2.5 sm:px-3">
          <p className="text-[10px] sm:text-xs text-slate-400">Your responses</p>
      ...
      <div className="mt-2 sm:mt-3 rounded-lg sm:rounded-xl border border-cyan-400/20 bg-slate-900/65 p-2.5 sm:p-3">
        ...
        <div className="mt-2 flex items-center gap-3 sm:gap-6 rounded-lg sm:rounded-xl border border-cyan-400/20 bg-slate-950/70 p-2 sm:p-2 sm:pl-6">
          ...
          <div className="min-w-0 flex-1 text-left">
            ...
            <p className="mt-0.5 sm:mt-1 text-[10px] sm:text-xs text-slate-300">Full Stack developer</p>
            ...
            <div className="mt-1.5 sm:mt-2 flex items-center justify-start gap-2 sm:gap-3">
              ...
              >
                <svg viewBox="0 0 24 24" aria-hidden="true" className="h-4 w-4 sm:h-5 sm:w-5 fill-current">
